...
```{r load_data}
gapminder <- read.table("unix_shell/Data/gapminder.txt", header=TRUE)
gapminder
```
...
```{r, echo=FALSE, eval=FALSE, warning=FALSE, fig.height=8, fig.width=8}
...
The average of the class is 44.063946. `r round(44.063946, 2)`